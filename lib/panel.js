// The debate panel: five distinct Claude models, each with its own persona,
// plus a judge that synthesizes the verdict. Models and personas can be
// overridden via environment variables (DEBATER_MODELS as a comma-separated
// list of five model IDs, JUDGE_MODEL for the judge).
